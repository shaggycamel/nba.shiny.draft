...
usethis::use_mit_license("Oliver Eaton") # You can set another license here
golem::use_readme_rmd(open = FALSE)
devtools::build_readme()
# Note that `contact` is required since usethis version 2.1.5
# If your {usethis} version is older, you can remove that param
usethis::use_code_of_conduct(contact = "Oliver Eaton")
...
golem::use_favicon()
# https://images.icon-icons.com/2622/PNG/512/sport_basketball_icon_157427.png
